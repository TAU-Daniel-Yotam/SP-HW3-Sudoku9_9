...
/**
* Parser Summary:
* This module contains all the function related to recieving and interperting the input from the user
*
* getInput      - recieves input from the user .
* parsedCommand - Interprets the command that the user wants to invoke and if the command is valid.
...
* @param parsedCommand- an int array :
        parsedCommand[0]- 1=set,2=hint,3=validate,4=restart,5=exit 6=invalid command.
...
/**
* @param word- a string that repersent a number.
